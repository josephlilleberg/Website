        ...
        <div className="mt-12 flex justify-center space-x-4">
          {navigation.social.map((item) => (
            ...
            >
              ...
              <item.icon className="h-[1.2rem] w-[1.2rem]" aria-hidden="true" />
            </a>
          ))}
        </div>
        <p className="mt-8 text-center text-xs text-gray-400 md:text-sm">
          Designed and built by Joseph Lilleberg
        </p>
        <p className="my-2 text-center text-sm text-gray-400 md:text-base">
          &copy; 2022 Joseph Lilleberg. All rights reserved.
        </p>
      </div>
    </footer>
  );
